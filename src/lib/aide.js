...
//  depuis l'écran d'erreur de l'invité, le tableau de bord, le mail de
//  création ou le pied de page.
// ============================================================

export const AIDE = {
  title: 'Un invité bloqué ?',
  ...
  caption: "Un invité scanne un QR code posé sur une table, en soirée",
  body: `<p>Neuf fois sur dix, un invité bloqué l’est pour une des raisons ci-dessous — et la solution prend moins d’une minute. Garde cette page sous la main le jour J : elle est faite pour être transférée telle quelle à quelqu’un qui coince.</p>
...
<p>Rappel utile à faire passer : <strong>un invité ne voit que ses propres photos.</strong> Il ne verra celles des autres qu’à la révélation. Ce n’est pas un bug, c’est le principe.</p>
...
<p>Si l’invité est rentré chez lui, dis-lui de chercher dans l’historique de son navigateur, ou renvoie-lui simplement le lien d’invitation.</p>
...
<p>Time to Flash reconnaît un <strong>téléphone</strong>, pas une personne. Deux invités qui photographient depuis le même appareil <strong>partagent la même pellicule</strong> et le même compteur. Il n’y a pas de contournement : c’est ce qui permet de ne demander aucun compte ni mot de passe.</p>
<p>Si c’est gênant, l’un des deux peut ouvrir le lien dans un autre navigateur du téléphone (Chrome au lieu de Safari, par exemple) : il sera compté comme un nouvel invité.</p>

<h2>9. « J’ai tout perdu » — la navigation privée</h2>
<p>En navigation privée, le téléphone oublie tout dès que l’onglet se ferme. L’invité repart alors de zéro, avec un compteur remis à neuf — et ses photos précédentes ne lui sont plus rattachées.</p>
...
<p>Si plus d’invités que prévu ont scanné, la révélation attend que tu passes à la formule correspondante. Ton tableau de bord te le dit, avec le montant exact de la différence — tu ne repaies jamais ce qui l’a déjà été. Aucune photo n’est perdue entre-temps.</p>
