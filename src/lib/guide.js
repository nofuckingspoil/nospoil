...
export const GUIDE = {
  ...
  promise:
    "Sept chapitres courts pour que vos invités jouent le jeu, que vos photos soient réussies, et que la révélation soit un moment — pas un dossier de plus sur votre téléphone.",
...
export const CHAPTERS = [
  {
    ...
    body: `
<p>C'est le réglage qui change tout, et le plus souvent mal choisi. Trop de clichés, et la contrainte disparaît : vos invités mitraillent, vous récupérez 400 photos floues. Trop peu, et certains n'osent pas les utiliser, de peur de « gâcher ».</p>
...
<p>Vous pouvez prévoir une recharge de 1 à 5 photos, offerte automatiquement à l'invité qui a épuisé son quota. C'est un excellent réglage : ceux qui s'en fichent ne la demanderont jamais, et ceux qui ont pris goût au jeu repartent pour un tour.</p>
...
<ul>
  ...
  <li><strong>Plus d'un mois après.</strong> L'élan est perdu, une partie des invités ne rouvrira pas le lien.</li>
</ul>
...
`,
  },
  {
    ...
    teaser: "Où poser le code, quoi dire au micro, et l'astuce pour les invités qui n'y arrivent pas seuls.",
    body: `
<p>C'est le seul vrai obstacle de la soirée : un invité qui n'a pas scanné ne prendra aucune photo. Voici ce qui fonctionne.</p>
...
<p>Beaucoup d'invités n'osent pas déclencher de peur de gâcher une pose. Dites-leur : <strong>une photo ratée peut être supprimée, et la place se libère</strong>. Ils ne pourront jamais dépasser leur quota, mais ils ne sont pas punis pour un flou. Ça débloque énormément de monde.</p>
`,
  },
  {
    n: 5,
    ...
    body: `
<p>Entre la fin de l'événement et la révélation, <strong>vous êtes le seul à voir les photos</strong>. Vos invités, eux, ne voient que les leurs. C'est votre fenêtre de tri, et il faut la prendre au sérieux — c'est ce qui différencie une galerie qu'on partage d'une galerie qu'on regrette.</p>
...
`,
  },
  {
    ...
    body: `
<p>Vos invités reçoivent une notification à l'ouverture de la galerie. Mais un message de votre part au même moment change complètement l'ampleur de la chose.</p>
...
<p>Faites imprimer une dizaine de photos. Une galerie participative produit des images qu'aucun photographe professionnel n'aurait pu prendre — le point de vue de vos invités. Ce sont souvent celles qui finissent au mur.</p>
`,
  },
]
...
export const CHECKLIST = [
  ...
  },
  {
    when: 'Jour J',
    items: [
      'Poser les QR codes avant l\'arrivée des invités',
